...
const Myblog = () => {
  ...
  <div className="max-w-6xl mx-auto relative z-10">
    ...
    <p className="text-gray-400 mb-10">View and manage the blogs you've published.</p>
        ...
        >
          <div className="flex flex-col gap-4">
            <div className="flex justify-between items-center flex-wrap gap-3">
              <h3 className="text-2xl font-bold text-white">{cleanTitle(blog.title)}</h3>
            ...
            <div className="flex justify-between items-center pt-2">
              <span className="text-xs text-gray-400">✍️ {blog.author}</span>
              <div className="space-x-4">
                <button className="text-yellow-400 hover:text-yellow-300 font-medium transition duration-150">
                  ✏️ Edit
                </button>

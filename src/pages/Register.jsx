...
function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] px-2">
      <div className="bg-[#1c1c1c] shadow-xl rounded-xl p-6 max-w-sm w-full relative overflow-hidden">
        {/* Glowing Background */}
        <div className="absolute -top-10 -left-10 w-32 h-32 bg-gradient-to-br from-orange-500 to-yellow-400 rounded-full blur-3xl opacity-30 animate-pulse z-0"></div>

        <div className="relative z-10">
          {/* Logo */}
          <div className="flex justify-center mb-4">
            <div className="relative flex justify-center items-center">
              <div className="absolute w-24 h-24 bg-gradient-to-br from-orange-500 to-yellow-400 rounded-full blur-2xl opacity-30 animate-pulse" />
              <img
                src="/logo.png"
                alt="App Logo"
          ...
          >
            <input
              ...
              className="w-full px-3 py-2 bg-[#2c2c2c] text-white border border-gray-600 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-orange-400"
              value={formData.name}
          ...
          <button
            ...
            className="w-full bg-black hover:bg-gray-900 text-white text-sm font-medium py-2 rounded-md flex items-center justify-center space-x-2"
          >
